...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyATVnBKVK8bHtcvOnHKdjFCIvwrQrPcnzQ"></script>	
<script>
// map
var poly = '';
var map;
...
function initialize() {	
	...
	var mapOptions = {
		zoom: 13,
		center: new google.maps.LatLng(-7.279262, 112.790341)
	};
...
<h1>PETA INSTITUT TEKNOLOGI SEPULUH NOPEMBER, SURABAYA</h1>
<h2>Implementasi Algoritma Djikstra Teori Graf D</h2>
<br>
